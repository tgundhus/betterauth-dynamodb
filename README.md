...
Production-oriented DynamoDB adapter for Better Auth `^1.6.23`, implemented with Better Auth's official `createAdapterFactory` API. Compatibility has been checked against Better Auth 1.6.23 and 1.6.25 adapter factory behavior.
