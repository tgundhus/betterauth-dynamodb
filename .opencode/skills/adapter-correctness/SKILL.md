...
Update `README.md` when the change affects options, table provisioning, storage layout, concurrency guarantees, limitations, or Document Hub-style SST usage. Update `AGENTS.md` if an invariant changes.
